        ...
        <?php } else { ?>
            <?php foreach ($model['kategori'] as $item) { ?>
                ...
                <tr>
                    ...
                    <td><a href="/dashboard/kategori/hapus/<?= $item['id_kategori'] ?>" onclick="return confirm('apakah anda yakin?')">hapus</a> <a href="/dashboard/kategori/ubah-kategori/<?= $item['id_kategori'] ?>">edit</a></td>
                </tr>
            <?php } ?>
        <?php } ?>
    </table>
